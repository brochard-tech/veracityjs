...
exports.Type = {
    ...
    Object: function (waterfallValidation) {
        return new VeracityType('object', function (property, values) {
            return (typeof(property) === 'object' && !(property instanceof Array)) ? (values ? exports.validate(property, values) : true) : false;
        }, waterfallValidation);
    },
...
exports.validateFormat = function (property, veracityType) {
    if (property == null || !veracityType || (veracityType && !(veracityType instanceof VeracityType))) {
        return false;
    }
